...
### SDSS ###
python -m src.strategies.ir_1_x_1 -dataset sdss_data.csv

python -m src.pipeline.dataset_split -dataset sdss_data_ir_1_x_1_experrs.csv -p 60:20:20

python -m src.pipeline.dataset_scaling -datafiles sdss_data_ir_1_x_1_experrs_train.csv sdss_data_ir_1_x_1_experrs_val.csv sdss_data_ir_1_x_1_experrs_test.csv -scaler StandardScaler

python -m src.training -n sdss_training_ir_1_x_1 -e 10 -dp ErrorBasedInvertedRandomDropout -runs 1 -trainset sdss_data_ir_1_x_1_experrs_train_scaled.csv -valset sdss_data_ir_1_x_1_experrs_val_scaled.csv

BEST_MODEL=$(python -m src.modules.best_model_selector -n sdss_training_ir_1_x_1)

python -m src.predict -model $BEST_MODEL -testset sdss_data_ir_1_x_1_experrs_test.csv -dp y
