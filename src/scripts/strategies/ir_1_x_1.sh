...
python -m src.training -n sdss_training_ir_1_x_1 -e 10 -dp ErrorBasedInvertedRandomDropout -runs 2 -trainset sdss_data_ir_1_x_1_experrs_train_scaled.csv -valset sdss_data_ir_1_x_1_experrs_val_scaled.csv

BEST_MODELS=$(python -m src.modules.best_model_selector -n sdss_training_ir_1_x_1 -e 10)

eval "python -m src.predict -models ${BEST_MODELS} -testset sdss_data_ir_1_x_1_experrs_test.csv -dp y"
