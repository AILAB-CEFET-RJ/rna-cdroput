...
do
    ...
    do
        ...
        do
            ...
            eval "python -m src.training -n ${dataset}_training_${regressor}_${strategy} -e 3000 -dp ErrorBasedInvertedRandomDropout -runs 3 -trainset ${dataset}_data_${regressor}_${strategy}_experrs_train_scaled.csv -valset ${dataset}_data_${regressor}_${strategy}_experrs_val_scaled.csv"
...
python -m src.training -n teddy_training_ir_1_x_1 -e 3000 -dp ErrorBasedInvertedRandomDropout -runs 3 -trainset teddy_data_ir_1_x_1_experrs_train_scaled.csv -valset teddy_data_ir_1_x_1_experrs_val_scaled.csv
...
python -m src.training -n happy_training_ir_1_x_1 -e 3000 -dp ErrorBasedInvertedRandomDropout -runs 3 -trainset happy_data_ir_1_x_1_experrs_train_scaled.csv -valset happy_data_ir_1_x_1_experrs_val_scaled.csv
