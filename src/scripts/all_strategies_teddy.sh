...
python -m src.training -n teddy_experimento_dt_many_to_many -e 10 -dp ErrorBasedInvertedRandomDropout -runs 1 -trainset teddy_data_dt_m_x_m_experrs_train_scaled.csv -valset teddy_data_dt_m_x_m_experrs_val_scaled.csv
