...
def parser():
    ...
    parse.add_argument('-model', metavar='MODEL', help='Model filename.')
...
def predict(model_file, testset, batch_size, dropout):
    ...
    test_df = pd.read_csv(testset, comment='#')
    print(f"Train set loaded! Shape = {test_df.shape}")
...
if __name__ == '__main__':
    ...
    predict(args.model, args.testset, args.bs, args.dp)
