...
python ./knn_one_to_one.py -dataset teddy_data.csv
python ./knn_one_to_one.py -dataset happy_data.csv
...
python ./training.py -n teddy_experimento_one_to_one -e 10 -dp ErrorBasedInvertedRandomDropout -runs 1 -trainset teddy_data_knn_experrs_train_scaled.csv -valset teddy_data_knn_experrs_val_scaled.csv
python ./training.py -n happy_experimento_one_to_one -e 10 -dp ErrorBasedInvertedRandomDropout -runs 1 -trainset happy_data_knn_experrs_train_scaled.csv -valset happy_data_knn_experrs_val_scaled.csv

python ./dataset_download.py -dataset sdss
python ./dataset_clean.py -dataset sdss_data.csv
python ./knn_one_to_one.py -dataset sdss_data_clean.csv
